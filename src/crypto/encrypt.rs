...
impl Encrypt0 {
    pub fn new(key: [u8; 32], kid: &[u8]) -> Self {
    ...
    pub fn encrypt(&self, plaintext: &[u8], aad: &[u8]) -> anyhow::Result<Vec<u8>> {
...
mod tests {
    ...
    fn encrypt0_works() {
        ...
        let encrypt0 = Encrypt0::new(key, b"test");

        let plaintext = b"hello world";
        let data = encrypt0.encrypt(plaintext, b"yiwen.ai").unwrap();
